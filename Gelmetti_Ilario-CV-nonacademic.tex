...
\def \spaziatura {14}
\def \spaziaturadue {17}

\ecvname{Gelmetti, Ilario}
\ecvfootername{Ilario Gelmetti}
\ecvaddress{Barcelona 08014, Spain}
\ecvtelephone{}
\ecvfax{}
...
\ecvitem{May 2023 -- resent}{\textbf{R\&D Engineering Manager}. \textbf{\href{https://www.vitsolc.com/}{Vitsolc Technologies}}, Castelldefels, Barcelona, Spain.}
\ecvitem{Project}{Technology validation, with design and creation of custom electrical characterization equipment, for outdoor characterization of semitransparent solar cells; project manager.\vspace{\spaziatura pt}}

\ecvitem{July 2020 -- May 2023}{\textbf{Post-Doc researcher}. \textbf{Prof. J. R. Galán Mascarós group, Institute of Chemical Research of Catalonia} (ICIQ), Tarragona, Spain.}
\ecvitem{Project}{Development of electrodes for electrocatalytic ethanol oxidation (\url{https://decadeproject.eu/}) and mid-scale water splitting; scale-up and automatization of synthesis, deposition and data analysis processes.}%\vspace{\spaziatura pt}}
...
\ecvitem{Acquired experience}{LibreMesh design and network architecture; OpenWrt administration, configuration and debugging; Lua coding; BASH scripting.}%\vspace{\spaziatura pt}}

\ecvsection[5pt]{Education}

%\ecvitem{Dates}{January 2015 -- July 2019}
\ecvitem{Jan. 2015 -- July 2019}{\textbf{Pre-Doc researcher}. \textbf{Prof. Emilio Palomares group, Institute of Chemical Research of Catalonia} (ICIQ) and Department of Electrical Electronic Engineering and Automation of Universitat Rovira i Virgili (DEEEA-URV), Tarragona, Spain. PhD evaluation excellent \textit{cum laude} and international mention.}  
...
\ecvitem{Internship}{3 months, Dr. Piers Barnes Group, Dept. of Physics, {\bf Imperial College London}, UK.\vspace{\spaziatura pt}}
...
\ecvitem{Laboratory}{Institute for Macromolecular Studies, {\bf Consiglio Nazionale delle Ricerche, Milan}, Italy.\vspace{\spaziatura pt}}%\vspace{\spaziatura pt}}% (ISMAC-CNR)
...
\ecvlanguage{Spanish}{\ecvCTwo}{\ecvCOne}{\ecvCTwo}{\ecvCOne}{\ecvCOne}
...
\ecvitem[0pt]{Language certificates}{Catalan language C1, issued by Universitat Rovira i Virgili, July 2020.
	...
	English language C1, issued by Escuela Oficial de Idiomas de Tarragona, February 2022.\vspace{\spaziaturadue pt}}
...
\ecvitem[5pt]{Computer skills}{Git version control; Debian and Arch Linux system administration; cabled and wireless networks setup and administration using OpenWrt; \LaTeX\ markup; LibreOffice Writer, Calc and Impress; GIMP and Inkscape drawing; prototyping with Arduino and electronics; assembling and repairing PCs and electronic hardware in general.\vspace{\spaziaturadue pt}}

\ecvitem[5pt]{Coding skills}{BASH scripting (medium); coding in Python (medium, e.g. \href{https://github.com/ilario/PyPV}{PyPV data acquisition software} and \href{https://github.com/ilario/electrochemistry-data-processing-python}{data processing for electrochemistry data}), coding in R (advanced, e.g. \href{https://github.com/ilario/photophysics-data-processing-R}{data processing for photovoltaics}), coding in Matlab (medium, e.g. \href{https://github.com/barnesgroupICL/Driftfusion/tree/2018-EIS}{contributions to Driftfusion}), coding in Lua (medium, e.g. \href{https://github.com/libremesh/lime-packages/commits?author=ilario}{contributions to LibreMesh}).\vspace{\spaziaturadue pt}}
...
\ecvitem[5pt]{Volunteering}{Operazione Mato Grosso (2004--2007), eigenLab Pisa and eigenNet wireless community network (2009--2013), Manitese (2013), NinuxVerona wireless community network (founder, 2014--2015, \href{https://www.youtube.com/watch?v=llCQlT0cJuU}{presentation video}), LibreMesh.org modular firmware for community networks (developer and community manager, 2013--; real network setup for events \href{https://it.hackmeeting.org}{it.hackmeeting.org}, June 2017; \href{https://es.hackmeeting.org}{es.hackmeeting.org}, September 2019; \href{https://battlemesh.org/BattleMeshV15}{WirelessBattleMesh v15}, 2023), TGNU Tarragona hacklab (co-founder, 2016--2018), No Board Games (game developer, 2014--), Logout hacklab (2022--\.).\vspace{\spaziaturadue pt}}

%\ecvitem[10pt]{Marital situation}{Unmarried.}
\ecvitem[15pt]{Hobbies and Interests}{Open source software, computer security, wireless community networks, activism, prototyping, electronics, problem solving, board games design, learning languages.\vspace{\spaziaturadue pt}}
...
\ecvsection[5pt]{References}
\ecvitem[5pt]{}{Prof. {\bf José Ramón Galán-Mascarós}, \textit{Group leader} at Institute of Chemical Research of Catalonia (ICIQ), Tarragona, Spain. \quad\url{jrgalan@iciq.es} \quad +34 977 920 200 (ext. 221)}

%\ecvitem{\large\textbf{References}}{Dr. \bf{Piers R. F. Barnes}}
\ecvitem[5pt]{}{Dr. {\bf Piers R. F. Barnes}, \textit{Lecturer} at Dept. of Physics, Imperial College London (ICL), London, UK. \quad\url{piers.barnes@imperial.ac.uk} \quad +44 (0)20 7594 7609}

\ecvitem[5pt]{}{Prof. {\bf Emilio Palomares}, \textit{Director} of Institute of Chemical Research of Catalonia (ICIQ), Tarragona, Spain. \quad\url{epalomares@iciq.es} \quad +34 977 920 245}
